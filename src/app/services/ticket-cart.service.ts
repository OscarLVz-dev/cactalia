...
export class TicketCartService {
  ...
  sendCart() {
    ...
    let products = "";
    let footer = "%0A%0A----------------------------------%0A *TOTAL:* $"+this.getTotal()+"%0A%0A ℹ️ La disponibilidad y precios de los productos están sujetos a revisión por posibles modificaciones en el mensaje. %0A%0A ¡Hola! Te envio mi carrito de compras 🛍️😁.";
